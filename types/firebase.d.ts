 ...
 * Betting Site Widget
 */
export interface FIREBASE_FeaturedSite {
 ...
 * on the DB.
 */
export interface FIREBASE_FinalFeaturedSiteResponseDB {
	site_data_array: Array<FIREBASE_FeaturedSite>; // contains the array of `FeaturedSite` data from the website
 ...
 */
export interface FIREBASE_SelectedFixture_LiveOdds_Response {
	fixture_odds: {
		gameid: number;
		markets: {
			'1X2FT': {
