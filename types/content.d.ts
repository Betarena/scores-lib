...
import { B_H_EC, B_H_HF, B_H_HF_AG, B_H_SFCT, B_H_SFSD, B_H_SGT, FixtureContentTranslations, WelcomeMonths, WidgetsNoDataAvailable } from "./hasura"
...
// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface B_CONT_D 
  extends CONT_Fixture {
  // empty
}
...
export interface B_H_CONT_Q {
  scores_football_seasons_details:  B_H_SFSD[]
  historic_fixtures_aggregate:      B_H_HF_AG
  historic_fixtures:                B_H_HF[]
  external_content_aggregate:       B_H_HF_AG // FIXME: not right type
  external_content:                 B_H_EC[]
  // NOTE: translations
  scores_general_translations?:     B_H_SGT[]
  scores_fixtures_content_translations: B_H_SFCT[]
}
